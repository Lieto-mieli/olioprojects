...
class Miekka : Esine
{
    ...
    public Miekka(SwordType type, double weight, double volume, ConsoleColor color)
    {
        paino = weight;
        tilavuus = volume;
        tyyppi = type;
...
class Jousi : Esine
{
    ...
    public Jousi(BowType type, double weight, double volume, ConsoleColor color)
    {
        paino = weight;
        tilavuus = volume;
        tyyppi = type;
...
class Nuoli : Esine
{
    ...
    public Nuoli(double weight, double volume, ConsoleColor color)
    {
        paino = weight;
        tilavuus = volume;
        väri = color;
...
class Ruoka_Annos : Esine
{
    ...
    public Ruoka_Annos(double weight, double volume, ConsoleColor color)
    {
        paino = weight;
        tilavuus = volume;
        väri = color;
...
class Potion : Esine
{
    ...
    public Potion(PotionType type, double weight, double volume, ConsoleColor color)
    {
        paino = weight;
        tilavuus = volume;
        nimi = type;
                ...
                case 1:
                    ...
                    switch (Convert.ToInt32(Console.ReadLine()))
                    {
                        case 1:
                            ...
                            while (true)
                            {
                                Console.WriteLine("Choose Sword color. Choices are:");
                                ...
                                string colorAnswer = Console.ReadLine();
                                if (Enum.TryParse<ConsoleColor>(colorAnswer, true, out väriyksi))
                                {
                                    if (long.TryParse(colorAnswer, out number1))
                                    {
                                ...
                                if (valid)
                                {
                                    väriyksi = Enum.Parse<ConsoleColor>(colorAnswer, true);
                                    break;
                                }
                                Console.WriteLine("Invalid selection. Please input the name of a color, or its order in the list");
                            }
                            if (pack.Lisää(new Miekka(matsku1, tempnum1, tempnum2, väriyksi)))
                            {
                        ...
                        case 2:
                            ...
                            while (true)
                            {
                                Console.WriteLine("Choose Bow color. Choices are:");
                                foreach (int i in Enum.GetValues(typeof(ConsoleColor)))
                                {
                                    Console.Write($"{Enum.GetName(typeof(ConsoleColor), i)}");
                                    Console.WriteLine($" {i}, ");
                            ...
                            if (pack.Lisää(new Jousi(matsku2, tempnum1, tempnum2, väriyksi)))
                            {
                        ...
                        case 3:
                            ...
                            while (true)
                            {
                                Console.WriteLine("Choose arrow color. Choices are:");
                                foreach (int i in Enum.GetValues(typeof(ConsoleColor)))
                                {
                                    Console.Write($"{Enum.GetName(typeof(ConsoleColor), i)}");
                                    Console.WriteLine($" {i}, ");
                            ...
                            if (pack.Lisää(new Nuoli(tempnum1, tempnum2, väriyksi)))
                            {
                        ...
                        case 4:
                            ...
                            while (true)
                            {
                                Console.WriteLine("Choose box color. Choices are:");
                                foreach (int i in Enum.GetValues(typeof(ConsoleColor)))
                                {
                                    Console.Write($"{Enum.GetName(typeof(ConsoleColor), i)}");
                                    Console.WriteLine($" {i}, ");
                            ...
                            if (pack.Lisää(new Ruoka_Annos(tempnum1, tempnum2, väriyksi)))
                            {
                        ...
                        case 5:
                            ...
                            while (true)
                            {
                                Console.WriteLine("Choose bottle color. Choices are:");
                                foreach (int i in Enum.GetValues(typeof(ConsoleColor)))
                                {
                                    Console.Write($"{Enum.GetName(typeof(ConsoleColor), i)}");
                                    Console.WriteLine($" {i}, ");
                            ...
                            if (pack.Lisää(new Potion(matsku3, tempnum1, tempnum2, väriyksi)))
                            {
...
public class Backpack
{
    ...
    public string Tulostasisältö()
    {
        ...
        {
            Console.ForegroundColor = inventory[i].väri;
            Console.Write($"{tempstr}{inventory[i]}, ");
            Console.WriteLine("");
        }
        Console.ForegroundColor= ConsoleColor.White;
        return tempstr;
